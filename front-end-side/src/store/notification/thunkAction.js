...
export const getAllNotifiEvent = createAsyncThunk(
  "/notification/getallNotifiEvent",
  async (query, { rejectWithValue }) => {
    try {
...
export const getNotifiEventDetail = createAsyncThunk(
  `/notification/getNotifiEventDetail`,
  async (query, { rejectWithValue }) => {
    try {
...
export const deleteNotifiEvent = createAsyncThunk(
  "/notification/deleteNotifiEvent",
  async (query, { rejectWithValue }) => {
    try {
...
//get camera face warning event
export const getCameraFaceEvent = createAsyncThunk(
  "/notification/getCameraFaceEvent",
  async (query, { rejectWithValue }) => {
    try {
      const res = await notificationService.getCameraFaceEvent(query);
      return res.data.content;
    } catch (error) {
      return rejectWithValue(error);
    }
...
export const getFaceWarningStats = createAsyncThunk(
  "/notification/getFaceWarningStats",
  async (query, { rejectWithValue }) => {
    try {
      const res = await notificationService.getFaceWarningStats(query);
      return res.data.content;
    } catch (error) {
      return rejectWithValue(error);
    }
